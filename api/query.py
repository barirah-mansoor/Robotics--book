...
if not GEMINI_API_KEY:
    # In Vercel environment, the API key will be set as an environment variable
...
# Vercel API route - this is the correct format
...
# Export the POST function for Vercel
__all__ = ['POST']